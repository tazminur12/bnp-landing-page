...
export default function ProfileFrameCampaign() {
  ...
  const instructions = [
    ...
    "JPG বা PNG ফরম্যাটের ছবি আপলোড করুন (সর্বোচ্চ 5MB)",
    "আপনার ছবি সার্ভারে সংরক্ষণ করা হবে না - সম্পূর্ণ নিরাপদ"
  ];
  ...
  const handleFileSelect = (file) => {
    if (file && (file.type === "image/jpeg" || file.type === "image/png")) {
      ...
      reader.onerror = () => {
        alert("ছবি পড়তে সমস্যা হয়েছে। দয়া করে আবার চেষ্টা করুন।");
  ...
  const applyFrame = (imageData) => {
    ...
    // Set canvas size to match standard profile picture
    canvas.width = 1080;
    canvas.height = 1080;
    ...
    img.onload = () => {
      ...
      // Draw uploaded image (fill the canvas)
      ...
      frameImg.onload = () => {
        console.log("Frame loaded, drawing on top");
      ...
      frameImg.onerror = (error) => {
        ...
        alert("ফ্রেম লোড করতে সমস্যা হয়েছে। দয়া করে পেজ রিফ্রেশ করে আবার চেষ্টা করুন।");
        
        // Still show the user's image without frame
        setFramedImage(canvas.toDataURL("image/png", 1.0));
        setIsProcessing(false);
      };
      
      frameImg.src = "/frame/frame1.png";
    };
    
    img.onerror = (error) => {
      console.error("User image failed to load:", error);
      alert("ছবি লোড করতে সমস্যা হয়েছে। দয়া করে আবার চেষ্টা করুন।");
    };
  ...
  const downloadImage = () => {
    if (framedImage) {
      ...
      link.download = `profile-mir-shahe-alam-${Date.now()}.png`;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-sm sm:text-base max-w-2xl mx-auto">
            ...
            <br />
            <span className="text-yellow-400 font-semibold">বগুড়া-২ আসনে মীর শাহে আলমকে সমর্থন করুন!</span>
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            {instructions.map((instruction, index) => (
              <div key={index} className="flex items-start gap-2">
                <div className="shrink-0 w-4 h-4 rounded-full bg-green-500 flex items-center justify-center mt-0.5">
            ...
            <div className="bg-white/5 border-2 border-white/10 rounded-xl p-6 sm:p-8 text-center min-h-[250px] sm:min-h-[280px] flex flex-col items-center justify-center">
              {isProcessing ? (
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-white/80 text-sm">ছবিতে ফ্রেম যুক্ত করা হচ্ছে...</p>
                </div>
              ) : framedImage ? (
        ...
        <div className="text-center">
          ...
          <div className="inline-block bg-white/5 border-2 border-white/10 rounded-xl p-4 sm:p-5">
            ...
            <p className="text-white/60 text-xs sm:text-sm mt-3">
              এই ফ্রেম আপনার ছবিতে যুক্ত হবে
            </p>
          </div>
        </div>
